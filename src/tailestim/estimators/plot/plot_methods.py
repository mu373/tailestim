...
def make_plots(ordered_data, results, output_file_path, bootstrap_flag=True,
               diagn_plots=False, theta1=0.01, theta2=0.99,
    ...
    noise_flag : bool, optional
        ...
        data point. Used for integer-valued sequences, default is True.
...
def make_diagnostic_plots(ordered_data, results, output_file_path=None, hsteps=200,
                         bootstrap_flag=True, verbose=False, noise_flag=True,
                         savedata=False):
    """
